...
function handle_submit(&$selected_id)
{
	...
	if ($selected_id) 
	{
		update_customer($_POST['customer_id'], $_POST['CustName'], $_POST['cust_ref'], $_POST['address'],
			...
			input_num('credit_limit'), $_POST['sales_type'], $_POST['notes'],$_POST['tin_no'],$_POST['cst_no']);
...
function customer_settings($selected_id) 
{
	...
	if (!$selected_id) 
	{
	 	if (list_updated('customer_id') || !isset($_POST['CustName'])) {
			$_POST['CustName'] = $_POST['cust_ref'] = $_POST['address'] = $_POST['tax_id']  = $_POST['tin_no']  = $_POST['cst_no'] = '';
	...
	text_row(_("CST No:"), 'cst_no', null, 40, 40);
